...
import {
  CameraAlt, GitHub, Language, LinkedIn, Lock, Person, Phone, Place, Work,
...
const AdminProfilePage: React.FC = () => {
  ...
  return (
    <Box>
      <PageHeader title="Meu Perfil" subtitle="Gerencie suas informações de administrador" />
              ...
              <Badge
                ...
                badgeContent={
                  <Tooltip title="Alterar foto">
                    ...
                    >
                      {avatarLoading ? <CircularProgress size={14} color="inherit" /> : <CameraAlt sx={{ fontSize: 16 }} />}
                    </IconButton>
                  </Tooltip>
                }
              >
            ...
            <CardContent sx={{ p: 0 }}>
              ...
              <Box sx={{ px: 3, pb: 3 }}>
                ...
                <Box component="form" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <Grid container spacing={2.5}>
                      ...
                      <Grid size={{ xs: 12, sm: 6 }}>
                        <TextField
                          label="Cargo / Função"
                          fullWidth
                          placeholder="Ex: Administrador de Plataforma"
                          {...register('job_title')}
                      ...
                      <Grid size={{ xs: 12, sm: 6 }}>
                        <TextField
                          label="Departamento"
                          fullWidth
                          placeholder="Ex: Tecnologia Educacional"
                          {...register('department')}
                      ...
                      <Grid size={{ xs: 12 }}>
                        <TextField
                          ...
                          multiline
                          rows={4}
                          placeholder="Descreva brevemente sua trajetória e função na plataforma..."
                          {...register('bio')}
                          error={!!errors.bio}
                  ...
                  {/* Botão salvar visível nas abas 0 e 1 */}
                  {tab < 2 && (
